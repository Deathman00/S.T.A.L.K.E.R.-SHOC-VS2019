...
// R2-specific
Flags32 ps_r2_ls_flags = {R2FLAG_SUN | R2FLAG_SUN_TSM | R2FLAG_SUN_FOCUS | R2FLAG_SUN_IGNORE_PORTALS |
						  R2FLAG_SUN_DETAILS | R2FLAG_EXP_DONT_TEST_UNSHADOWED | R2FLAG_USE_NVSTENCIL |
						  R2FLAG_EXP_SPLIT_SCENE | R2FLAG_EXP_MT_CALC}; // r2-only
