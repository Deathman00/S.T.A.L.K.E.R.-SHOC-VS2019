...
void CPseudoGigant::Load(LPCSTR section)
{
	...
	// "fx_stand_l", "fx_stand_r");
	// anim().AddAnim(eAnimWalkFwd,		"stand_walk_fwd_",		-1, &velocity_walk,		PS_STAND,	"fx_stand_f", "fx_stand_b",
	// "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimWalkDamaged,	"stand_walk_fwd_dmg_",	-1, &velocity_walk_dmg,
	// PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"); anim().AddAnim(eAnimRun,
	// "stand_run_fwd_",		-1,	&velocity_run,		PS_STAND,	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
