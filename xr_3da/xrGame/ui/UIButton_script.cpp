...
void CUIButton::script_register(lua_State* L)
{
	module(L)[class_<CUIButton, CUIStatic>("CUIButton")
			  ...
			  */
			  ...
			  //.		.def("Init",
			  //(void(CUI3tButton::*)(LPCSTR,float,float,float,float))CUI3tButton::Init) .		.def("InitTexture",
			  //(void(CUI3tButton::*)(LPCSTR))CUI3tButton::InitTexture) .		.def("InitTexture",
			  //(void(CUI3tButton::*)(LPCSTR, LPCSTR, LPCSTR, LPCSTR))CUI3tButton::InitTexture) .
			  //.def("InitTextureE",			&CUI3tButton::InitTextureEnabled) .		.def("InitTextureD",
			  //&CUI3tButton::InitTextureDisabled) .		.def("InitTextureT",
