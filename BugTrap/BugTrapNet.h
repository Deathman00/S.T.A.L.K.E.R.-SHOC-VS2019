...
[Flags] public enum class FlagsType
{
	None = BTF_NONE,
...
[Flags] public enum class LogEchoType
{
	None = BTLE_NONE,
	StdOut = BTLE_STDOUT,
	StdErr = BTLE_STDERR,
...
[Flags] public enum class LogFlagsType
{
	None = BTLF_NONE,
...
[Flags] public enum class MinidumpType
{
...
public
ref class LogFileEntry : public BaseLogFileEntry
{
  public:
	inline LogFileEntry()
	{
...
public
ref class RegExportEntry : public BaseLogFileEntry
{
  public:
...
private
ref class LogFilesEnumerator sealed : public IEnumerator
{
  public:
	LogFilesEnumerator(void);
	virtual bool MoveNext(void) sealed;
	virtual void Reset(void) sealed;
	virtual property Object ^ Current { Object ^ get() sealed; }
...
private
ref class LogFilesEnumerable sealed : public IEnumerable
{
  public:
...
ref class LogFiles
{
  public:
	...
	static property IEnumerable ^
		Entries { IEnumerable ^ get(void); }

		private : static Object ^
				  GetLogFileEntry(INT_PTR index, bool getByIndex);
};
...
public
ref class UnhandledExceptionEventArgs : public System::UnhandledExceptionEventArgs
{
  public:
...
inline UnhandledExceptionEventArgs::UnhandledExceptionEventArgs(System::UnhandledExceptionEventArgs ^ args)
	: System::UnhandledExceptionEventArgs(args->ExceptionObject, true)
{
	this->type = BugTrap::ExceptionType::DomainException;
}

inline UnhandledExceptionEventArgs::UnhandledExceptionEventArgs(System::Threading::ThreadExceptionEventArgs ^ args)
	: System::UnhandledExceptionEventArgs(args->Exception, true)
{
...
ref class LogFile
{
  public:
	...
	property String ^ FileName { String ^ get(void); } property int LogSizeInEntries
	{
		int get(void);
		void set(int value);
	}
...
public
delegate void UnhandledExceptionDelegate(Object ^ sender, UnhandledExceptionEventArgs ^ args);

public
ref class ExceptionHandler
{
  private:
  ...
  public:
	...
	internal : static property System::Exception ^
			   Exception {
				   internal:
			   ...
			   static property UnhandledExceptionEventArgs ^
			   Arguments {
				   internal:
...
{
	HandleException(dynamic_cast<System::Exception ^>(args->ExceptionObject), sender,
					gcnew UnhandledExceptionEventArgs(args));
}
