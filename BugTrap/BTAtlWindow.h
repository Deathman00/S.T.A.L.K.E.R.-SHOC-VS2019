 ...
 */
template <class BASE_CLASS> inline WNDPROC BTWindow<BASE_CLASS>::GetWindowProc()
{
	return &WindowProc;
}
 ...
 * @return the return value depends on the message.
 */
template <class BASE_CLASS> LRESULT BTWindow<BASE_CLASS>::WindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
...
/// Only one form of exception handling is permitted per function,
/// therefore this class uses two functions to catch C++ and Windows errors.
template <class BASE_CLASS> class BTDialog : public BASE_CLASS
{
  protected:
	/// Object initialization (0 parameters).
	...
	/// Object initialization (1 parameter).
	template <typename T1> explicit BTDialog(T1 param1) _BTDLG_INITIALIZER_(param1)
	{
	}
	/// Object initialization (2 parameters)
	template <typename T1, typename T2> BTDialog(T1 param1, T2 param2) _BTDLG_INITIALIZER_(param1, param2)
	{
	}
	/// Object initialization (3 parameters).
	template <typename T1, typename T2, typename T3>
	...
	/// Object initialization (5 parameters).
	template <typename T1, typename T2, typename T3, typename T4, typename T5>
	BTDialog(T1 param1, T2 param2, T3 param3, T4 param4, T5 param5)
		_BTDLG_INITIALIZER_(param1, param2, param3, param4, param5)
	{
	}
 ...
 */
template <class BASE_CLASS> inline DLGPROC BTDialog<BASE_CLASS>::GetDialogProc()
{
	return &DialogProc;
}
 ...
 * @return the return value depends on the message.
 */
template <class BASE_CLASS> INT_PTR BTDialog<BASE_CLASS>::DialogProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
