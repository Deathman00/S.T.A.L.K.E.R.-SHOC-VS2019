...
static inline void setBall2(dxJoint* joint, dxJoint::Info2* info, dVector3 anchor1, dVector3 anchor2, dVector3 axis,
							dReal erp1)
{
	// anchor points in global coordinates with respect to body PORs.
	dVector3 a1, a2;
...
dxJoint::Vtable __dball_vtable = {sizeof(dxJointBall),
...
dxJoint::Vtable __dhinge_vtable = {sizeof(dxJointHinge),
...
dxJoint::Vtable __dslider_vtable = {sizeof(dxJointSlider),
...
dxJoint::Vtable __dcontact_vtable = {sizeof(dxJointContact),
...
dxJoint::Vtable __dcontact_special_vtable = {sizeof(dxJointContact),
											 (dxJoint::init_fn*)contactInit,
											 (dxJoint::getInfo1_fn*)contactGetInfo1,
...
dxJoint::Vtable __dhinge2_vtable = {sizeof(dxJointHinge2),
...
dxJoint::Vtable __duniversal_vtable = {sizeof(dxJointUniversal),
...
extern "C" void dJointSetAMotorAxis(dxJointAMotor* joint, int anum, int rel, dReal x, dReal y, dReal z)
{
	...
	dUASSERT(joint->vtable == &__damotor_vtable, "joint is not an amotor");
	dUASSERT(!(!joint->node[1].body && (joint->flags & dJOINT_REVERSE) && rel == 1),
...
dxJoint::Vtable __damotor_vtable = {sizeof(dxJointAMotor),
...
dxJoint::Vtable __dfixed_vtable = {sizeof(dxJointFixed),
...
dxJoint::Vtable __dnull_vtable = {sizeof(dxJointNull),
								  (dxJoint::init_fn*)0,
